(function(global){
  ...
  function injectCertificateStyles(){
    ...
    style.textContent=`
      ...
      .cert-scale-wrap>.cert-doc{width:min(100%,760px);min-height:auto;aspect-ratio:210/297;padding:clamp(44px,5vw,76px) clamp(36px,4.5vw,68px) clamp(34px,3.8vw,57px);transform:none!important;margin:0!important;}
      ...
      .cert-body{font-size:15px;line-height:2;color:#111827}.cert-intro{margin:0 0 7mm;text-indent:2em}.cert-info-table{width:min(100%,148mm);max-width:148mm;border-collapse:collapse;margin:0 auto 7mm;font-size:15px;table-layout:fixed}.cert-info-table th,.cert-info-table td{border:1px solid #111;padding:3.2mm 4mm;text-align:left;vertical-align:middle}.cert-info-table th{width:34mm;background:#f8fafc;text-align:center;font-weight:900}.cert-info-table td{width:auto}.cert-footer-text{width:min(100%,148mm);max-width:148mm;margin:3mm auto 8mm;text-indent:2em;font-size:12px;line-height:1.8;color:#374151}.cert-closing{font-size:17px;font-weight:900;letter-spacing:2px;margin-top:8mm;text-align:left}.cert-footer{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8mm;align-items:end;width:min(100%,160mm);max-width:160mm;margin:9mm auto 0;border-top:1px solid #e5e7eb;padding-top:6mm}.cert-bottom-info{display:flex;flex-direction:column;gap:4mm;min-width:0}.cert-brand-bottom{display:flex;align-items:center;gap:5mm;min-width:0}.cert-brand-logo-bottom{width:50mm;max-width:100%;max-height:18mm;object-fit:contain}.cert-brand-caption{font-size:12px;font-weight:900;letter-spacing:1px;color:#111827}.cert-issue{font-size:13px;line-height:1.75;font-weight:700;color:#111827}.cert-review-line{font-size:12px;color:#374151;margin-top:2mm}.cert-stamps{display:flex;justify-content:flex-end;gap:4mm;align-items:flex-end;min-width:62mm}.stamp-box{text-align:center;font-size:12px;color:#64748b;font-weight:800}.stamp-box img{display:block;width:29mm;height:29mm;object-fit:contain;margin:0 auto 2mm}.stamp-box.personal img{width:27mm;height:27mm}.cert-watermark{position:absolute;left:50%;top:47%;transform:translate(-50%,-50%) rotate(-24deg);font-size:34px;line-height:1.5;font-weight:950;color:rgba(185,28,28,.18);border:4px solid rgba(185,28,28,.16);border-radius:12px;padding:8mm 14mm;text-align:center;letter-spacing:4px;z-index:3;pointer-events:none;white-space:nowrap}.cert-preview .cert-body,.cert-preview .cert-footer{position:relative;z-index:1}.cert-scale-wrap{display:flex;justify-content:center;align-items:flex-start;overflow-x:auto;overflow-y:auto;background:#f8fafc;border:1px solid #e2e8f0;border-radius:20px;padding:16px;min-height:560px;max-width:100%;box-sizing:border-box}.cert-modal{position:fixed;inset:0;background:rgba(15,23,42,.55);z-index:9999;display:none;align-items:flex-start;justify-content:center;padding:22px;overflow:auto}.cert-modal.show{display:flex}.cert-modal-panel{background:#fff;border-radius:24px;padding:16px;max-width:min(100%,980px);box-shadow:0 25px 70px rgba(15,23,42,.32)}.cert-modal-actions{display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-bottom:12px}.cert-modal-actions .right{display:flex;gap:8px;flex-wrap:wrap}.cert-modal-actions button{width:auto}.cert-status-pill{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:5px 10px;font-size:12px;font-weight:900;background:#eef7f2;color:#166534}.cert-status-pill.pending{background:#fff7ed;color:#9a3412}.cert-status-pill.rejected{background:#fef2f2;color:#991b1b}@media(max-width:780px){.cert-scale-wrap{justify-content:center;min-height:430px;padding:10px}.cert-scale-wrap>.cert-doc{width:100%;padding:28px 22px 24px}.cert-info-table,.cert-footer-text{width:100%;max-width:100%}.cert-info-table th{width:96px}.cert-footer{grid-template-columns:1fr;gap:5mm;width:100%;max-width:100%}.cert-stamps{justify-content:center;min-width:0}.cert-brand-bottom{flex-direction:column;text-align:center;gap:2mm}.cert-brand-logo-bottom{width:46mm}.cert-modal{padding:10px}.cert-watermark{font-size:22px}}@media print{html,body{margin:0!important;background:#fff!important}body *{visibility:hidden!important}.print-host,.print-host *{visibility:visible!important}.print-host{position:absolute!important;left:0!important;top:0!important;width:210mm!important}.cert-doc{box-shadow:none!important;margin:0!important;transform:none!important}@page{size:A4 portrait;margin:0}}
    `;
