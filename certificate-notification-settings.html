(function(global){
  ...
  function idNumberOfRecord(o){ o=o||{}; return upperId(o.idNumber || o.idNo || o.nationalId || o.idNumberMasked || o['身分證字號'] || o['身份證字號'] || o['身分證'] || o['身份證']); }
  ...
  function normalizeApplication(row){
    ...
    return Object.assign({}, row, {
      ...
      idNumber:idNumberOfRecord(Object.assign({}, row, form)),
      status:statusLabel(row.status || row['狀態']),
      formData:Object.assign({}, form, {idNumber:idNumberOfRecord(Object.assign({}, row, form))}),
