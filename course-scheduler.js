(function(){
  ...
  function openTeacherPayroll(teacherId){currentTeacherId=teacherId;$('teacherPayrollMonth').value=teacherListMonthKey();renderTeacherPayroll();openModal('teacherPayrollModal');}
