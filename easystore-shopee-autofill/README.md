...
7. 0.3.30 會要求「所有網站」與腳本執行權限；這兩項用於頁內框選截圖，以及替更新前已開啟的普通網頁補載入收圖面板。
8. 同一台電腦不要同時保留舊版與 0.3.30；更新後重新整理營運中心，再重新開始搜圖。
...
2. 保留商品頁，另外開啟任何一般商品網頁；右上角會自動出現「柚子掌櫃收圖中」。
   - 開始搜圖時，0.3.30 也會替更新前已開著的普通網頁自動補載入；新開或重新整理的商品頁會照常自動出現。
