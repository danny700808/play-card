...
function contractHtml(contractText, signatureUrl, identityFiles = [], profile = {}) {
  ...
  const sealAssetVersion = '20260710-sealfix1';
  const companySealUrl = `${webBaseUrl()}kaili-school-seal.png?v=${sealAssetVersion}`;
  const personalSealUrl = `${webBaseUrl()}personal-seal.png?v=${sealAssetVersion}`;
