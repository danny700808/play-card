(function(){
  ...
  function switchView(view){
    if(view!=='calendar'&&afterWorkspaceReady(function(){switchView(view);}))return;
  ...
  function applyCalendarState(loaded){
    ...
    updateModeUI();refreshFormOptions();switchView('calendar');
  }
