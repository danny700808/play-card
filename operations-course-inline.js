(function (global) {
  ...
  var RUNTIME_URL = 'operations-course-inline-runtime.js?v=20260921-mobile-admin-v2';
  ...
  function inlineOverrides() {
    return [
      ...
      '@media(min-width:1100px){.course-inline-body #calendarPage .date-actions{gap:8px}.course-inline-body #calendarPage #calendarDate{width:168px;min-height:38px;font-size:16px}.course-inline-body #calendarPage #todayBtn,.course-inline-body #calendarPage #weekScheduleBtn{min-height:38px;padding:7px 14px;font-size:15px}.course-inline-body #calendarPage .date-heading{min-width:148px}.course-inline-body #calendarPage .date-heading strong{font-size:19px}.course-inline-body #calendarPage .calendar-toolbar{padding:9px 12px}}',
      '@media(min-width:1100px){.course-inline-body .teacher-payroll-filters #teacherSearch{flex:0 1 210px;width:210px;min-width:150px}.course-inline-body #teacherTransferBtn{white-space:nowrap}}',
  ...
  async function initialize() {
    ...
    loadingPromise = (async function () {
      ...
      shadow.innerHTML = '<link rel="stylesheet" href="' + STYLE_URL + '"><style>' + inlineOverrides() + '</style><link rel="stylesheet" href="operations-mobile-admin.css?v=20260921-v2"><div class="course-inline-body">' + template + '</div>';
      ...
      if(!global.YouziPayrollTransfer)await new Promise(function(resolve,reject){var script=global.document.createElement('script');script.src='payroll-transfer.js?v=20260920-v3-roc';script.onload=resolve;script.onerror=function(){reject(new Error('轉帳表元件載入失敗'));};global.document.body.appendChild(script);});
      await loadRuntime();
