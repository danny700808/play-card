(function (global) {
  ...
  var RUNTIME_URL = 'operations-course-inline-runtime.js?v=20260921-mobile-admin-v3';
  ...
  async function initialize() {
    ...
    loadingPromise = (async function () {
      ...
      shadow.innerHTML = '<link rel="stylesheet" href="' + STYLE_URL + '"><style>' + inlineOverrides() + '</style><link rel="stylesheet" href="operations-mobile-admin.css?v=20260921-v3"><div class="course-inline-body">' + template + '</div>';
