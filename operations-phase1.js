...
function renderSync(){
  ...
  const runSummary=latestRun&&latestRun.summary||{},platformFetch=runSummary.platformFetch||{},syncErrors=platformSyncAnomalies(),syncErrorGroups=platformSyncAnomalyGroups(syncErrors);
