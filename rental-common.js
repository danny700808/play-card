  ...
  function renderContractHtml(contract, opts){
    ...
    return `
      ...
      <div class="rental-contract-sheet">
        ...
        <div class="contract-date">中華民國 ${esc(dateText)}</div><div class="rental-page-no">第 1 頁 / 共 1 頁</div>
      </div>`;
  }
