...
test('obsolete waiting and input-stability search layers are completely removed', () => {
  ...
  for (const html of [portal, hub]) {
    ...
    assert.match(html, /operations-phase1\.css\?v=20260825-listing-action-grid-network-audit/);
    assert.match(html, /operations-phase1\.js\?v=20260825-listing-action-grid-network-audit/);
