...
assert(html.includes('teacher-course-portal-v8.css?v=20260908-continuous-swipe-v1'), '老師首頁樣式 cache key 過期');
assert(html.includes('teacher-course-portal-v8.js?v=20260908-continuous-swipe-v1'), '老師首頁程式 cache key 過期');
