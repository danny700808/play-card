...
function render(payroll,adjustments){const node={innerHTML:'',setAttribute(){}} ;vm.runInNewContext(fn+';renderPayroll();',{payrollStatus:'ready',data:{payroll,adjustments},payrollMonth:'2026-09',clean:v=>String(v||''),payrollShareLabel:()=> '60%',money:v=>'$'+v,escapeHtml:v=>String(v).replace(/</g,'&lt;'),document:{getElementById:()=>node}});return node.innerHTML;}
